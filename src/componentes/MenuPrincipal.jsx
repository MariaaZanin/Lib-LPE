...
import { logout, auth, signInWithGit } from '../firebaseConfig';
                                        ...
                                        <>
                                            ...
                                            >
                                                <MenuItem onClick={handleCloseNavMenuManutencoes}
                                                    component={NavLink} to="libs">
                                                    <Typography textAlign="center">Libs</Typography>
                                                </MenuItem>
                                            </Menu>
                                        </>
                                    }
                        ...
                        <Box sx={{ flexGrow: 0 }}>
                            <Tooltip title="Menu do usuário">
                                <IconButton onClick={handleOpenUserMenu} sx={{ p: 0 }}
                                    ...
                                    <Typography >
                                        {user ? user?.displayName : "Usuário não autenticado"}
                                    </Typography>
